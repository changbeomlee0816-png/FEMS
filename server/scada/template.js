...
// [에너지원, 계통명, 계통ID, 레벨, 연결계통ID, 장비ID, 채널, 전압, 기기종류,
//  정격전류, 차단용량, 정격용량, 보호요소, 구역, 기기TAG]
const EX_TREE = [
  [1, '제1수전 (RCP-1)', 1, 1, 0, 1, 1, 154, 'INCOMER', 1250, 50, 21000, '50/51,51N,67,87L', 'SUB', 'RCP-1'],
  [1, '주변압기 1', 2, 2, 1, 3, 1, 22.9, 'TR', 3150, null, 20000, '87T,49,64', 'SUB', 'MTR-1'],
  [1, '기계전기실 M/C', 3, 3, 2, 5, 4, 22.9, 'VCB', 1250, 25, 6000, '50/51,51G', 'MEP', 'VCB-201'],
  [1, '냉동기 1호', 4, 4, 3, 5, 1, 6.6, 'MOTOR', 400, null, 1200, '49,51', 'MEP', 'M-CH01'],
  [1, '냉동기 2호', 5, 4, 3, 5, 2, 6.6, 'MOTOR', 400, null, 1200, '49,51', 'MEP', 'M-CH02'],
  [1, '공기압축기 1호', 6, 4, 3, 5, 3, 6.6, 'MOTOR', 250, null, 750, '49,51', 'MEP', 'M-AC01'],
  [1, '제조1동 M/C', 7, 3, 2, 6, 3, 22.9, 'VCB', 1250, 25, 8000, '50/51,51G', 'FAB1', 'VCB-301'],
  [1, '사출기 라인 A', 8, 4, 7, 6, 1, 0.44, 'ACB', 2000, 65, 1600, '50/51,51N', 'FAB1', 'ACB-311'],
  [1, '사출기 라인 B', 9, 4, 7, 6, 2, 0.44, 'ACB', 2000, 65, 1600, '50/51,51N', 'FAB1', 'ACB-312'],
  [1, '제2수전 (RCP-2)', 10, 1, 0, 2, 1, 154, 'INCOMER', 1250, 50, 21000, '50/51,51N,67,87L', 'SUB', 'RCP-2'],
  [1, '주변압기 2', 11, 2, 10, 4, 1, 22.9, 'TR', 3150, null, 20000, '87T,49,64', 'SUB', 'MTR-2'],
  [1, '가스터빈 발전기 G1', 12, 3, 11, 7, 1, 3.3, 'GEN', 500, null, 2400, '32P,46,59,81', 'GEN', 'GTG-1'],
  [1, '옥상 태양광', 13, 3, 11, 8, 1, 0.44, 'PV', 1200, null, 800, '27,59,81', 'GEN', 'PV-01'],
];
...
async function buildTemplate(opts = {}) {
  ...
  writeGuide(et, S.ENERGY_TREE_SHEET, [
    ...
    ['기기TAG', '현장 반·기기 번호. 도면과 알람 목록에 그대로 표시됩니다. 예) VCB-201, MTR-1, RCP-2'],
  ...
  if (example) {
    fillRows(et, S.ENERGY_TREE_SHEET, EX_TREE.map((t) => ({
      ...
      protection: t[12], zoneCode: t[13], tag: t[14],
    })));
  }
